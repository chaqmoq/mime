extension MIME {
    static var map: [String: [String]] {
        return [
            ...
            "application/octet-stream": [
                "bin", "dms", "lrf", "mar", "so", "dist", "distz", "pkg", "bpk", "dump", "elc", "deploy", "exe",
            ...
            "text/x-svsrc": ["sv"],
            "text/x-systemd-unit": [
                "automount", "device", "mount", "path", "scope", "service", "slice", "socket", "swap", "target",
                "timer"
            ],
            "text/x-tcl": ["tcl", "tk"],
    ...
    static var reverseMap: [String: [String]] {
        return [
            ...
            "icns": ["image/x-icns"],
            "ico": [
                "application/ico", "image/ico", "image/icon", "image/vnd.microsoft.icon", "image/x-ico",
                "image/x-icon", "text/ico"
            ],
            ...
            "iso": [
                "application/x-cd-image", "application/x-gamecube-iso-image", "application/x-gamecube-rom",
                "application/x-iso9660-image", "application/x-saturn-rom", "application/x-sega-cd-rom",
                "application/x-wbfs", "application/x-wia", "application/x-wii-iso-image", "application/x-wii-rom"
            ],
            ...
            "oga": [
                "audio/ogg", "audio/vorbis", "audio/x-flac+ogg", "audio/x-ogg", "audio/x-oggflac",
                "audio/x-speex+ogg", "audio/x-vorbis", "audio/x-vorbis+ogg"
            ],
            "ogex": ["model/vnd.opengex"],
            "ogg": [
                "audio/ogg", "audio/vorbis", "audio/x-flac+ogg", "audio/x-ogg", "audio/x-oggflac",
                "audio/x-speex+ogg", "audio/x-vorbis", "audio/x-vorbis+ogg", "video/ogg", "video/x-ogg",
            ...
            "opus": ["audio/ogg", "audio/opus", "audio/x-ogg", "audio/x-opus+ogg"],
            ...
            "pdb": [
                "application/vnd.palm", "application/x-aportisdoc", "application/x-palm-database",
                "application/x-pilot"
            ],
            ...
            "rms": [
                "application/vnd.jcp.javame.midlet-rms", "application/vnd.rn-realmedia",
            ...
            "sdp": [
                "application/sdp", "application/vnd.sdp", "application/vnd.stardivision.impress",
                "application/x-sdp"
            ],
            ...
            "stylus": ["text/stylus"],
            "sub": [
                "image/vnd.dvb.subtitle", "text/vnd.dvb.subtitle", "text/x-microdvd", "text/x-mpsub",
                "text/x-subviewer"
            ],
            ...
            "swf": [
                "application/futuresplash", "application/vnd.adobe.flash.movie", "application/x-shockwave-flash"
            ],
            ...
            "vlc": [
                "application/m3u", "audio/m3u", "audio/mpegurl", "audio/x-m3u", "audio/x-mp3-playlist",
                "audio/x-mpegurl"
            ],
            ...
            "wmf": [
                "application/wmf", "application/x-msmetafile", "application/x-wmf", "image/wmf",
